<div id="modalOverlayEdit" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50 backdrop-blur-sm transition-opacity duration-300">
        
    <!-- Modal Container -->
    <div id="modalContainerEdit" class="bg-white rounded-2xl shadow-2xl w-full max-w-lg mx-4 transform transition-all duration-300 scale-95 opacity-0">
        ...
        <div class="flex items-center justify-between p-6 border-b border-gray-200">
            ...
            <button onclick="closeModalEdit()" class="text-gray-400 hover:text-gray-600 transition-colors duration-200">
        ...
        <form id="formEdit">
            ...
            <div class="p-6 space-y-5" id="form-body">
                ...
                <div>
                    ...
                    <input type="text" placeholder="Role Name" id="name_edit" name="name" class="w-full px-4 py-3 border border-gray-300 text-[12px] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 outline-none" required>
                </div>
                ...
                <div class="max-w-md">
                    ...
                    <select id="color_theme_edit" name="color_theme" class="w-full" required>
            ...
            <div class="flex items-center justify-end gap-3 p-6 border-t border-gray-200 bg-gray-50 rounded-b-2xl">
                ...
                <button type="submit" class="px-5 py-2.5 bg-yellow-600 text-white rounded-lg hover:bg-yellow-700 transition-colors duration-200 font-medium shadow-lg hover:shadow-xl">
