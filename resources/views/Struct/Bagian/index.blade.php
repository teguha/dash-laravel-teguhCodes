    ...
    <main class="p-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 mb-4">
            <div class="flex flex-col lg:flex-row md:items-left md:justify-between gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Structure Bagian</h2>
                    <p class="text-sm text-gray-500 mt-1">Manage and view all struture level bagian in the system</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            @php
                ...
                $columns = [
                    ...
                    ['field' => 'parent', 'label' => 'Parent', 'sortable' => true],
...
@push('custom-scripts')
    ...
    <script>
        ...
        const routes = {
            add     : "{{ route('admin.structure.bagian.store') }}",
            edit    : "{{ route('admin.structure.bagian.edit', ['id' => ':id']) }}",
            show    : "{{ route('admin.structure.bagian.edit', ['id' => ':id']) }}",
            track   : "{{ route('admin.structure.bagian.track', ['id' => ':id']) }}",
            delete  : "{{ route('admin.structure.bagian.delete', ['id' => ':id']) }}"
        };
        ...
        // $(function() {
            ...
            function loadTable(page = 1, start= '' , end = '') {
                $.ajax({
                    url: "{{ route('admin.structure.bagian.data') }}",
                    type: "GET",
                    data: {
