        ...
        <form id="formModal" data-type="add" data-url="#">
            ...
            <div class="p-6 space-y-5" id="form-body">
                ...
                <div>
                    ...
                    <input type="text" placeholder="Corporate Name" id="name" name="name" class="w-full px-4 py-3 border border-gray-300 text-[12px] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 outline-none" required>
                </div>

                <!-- Email  -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2 text-[14px]">
                        <i class="fas fa-calculator text-gray-400 mr-2"></i>Tax
                    </label>
                    <input type="text" placeholder="Tax" id="tax" name="tax" class="w-full px-4 py-3 border border-gray-300 text-[12px] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 outline-none" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" placeholder="Phone" id="phone" name="phone" class="w-full px-4 py-3 border border-gray-300 text-[12px] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 outline-none" required>
                </div>

                <!-- Address  -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2 text-[14px]">
                        <i class="fas fa-home text-gray-400 mr-2"></i>Address
                    </label>
                    <textarea placeholder="Address" id="address" name="address" class="w-full px-4 py-3 border border-gray-300 text-[12px] rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 outline-none" required></textarea>
                </div>
