...
@section('content')
    <main class="p-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 mb-4">
            <div class="flex flex-col lg:flex-row md:items-left md:justify-between gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Structure Main Corporate</h2>
                    <p class="text-sm text-gray-500 mt-1">Manage and view all struture level main corporate in the system</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            @php
                ...
                $columns = [
                    ...
                    ['field' => 'tax', 'label' => 'Tax', 'sortable' => false],
    ...
    {{-- modal --}}
    @include('Struct.Corporate.modal')
...
@push('custom-scripts')
    ...
    <script>
        ...
        const routes = {
            add     : "{{ route('admin.structure.corp.store') }}",
            edit    : "{{ route('admin.structure.corp.edit', ['id' => ':id']) }}",
            show    : "{{ route('admin.structure.corp.edit', ['id' => ':id']) }}",
            track   : "{{ route('admin.structure.corp.track', ['id' => ':id']) }}",
            delete  : "{{ route('admin.structure.corp.delete', ['id' => ':id']) }}"
        };
        ...
        // $(function() {
            ...
            function loadTable(page = 1, start= '' , end = '') {
                $.ajax({
                    url: "{{ route('admin.structure.corp.data') }}",
                    type: "GET",
                    data: {
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            if(type == 'edit'){
                                ...
                                // form Modal
                                let urlEdit = '{{ route('admin.structure.corp.update', ['id' => ':idx']) }}'.replace(':idx', idx);
