        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 mb-4">
            <div class="flex flex-col lg:flex-row md:items-left md:justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-1">Manage and view all blog in the system</p>
...
@push('custom-scripts')
    ...
    <script>
        ...
        const routes = {
            add     : "{{ route('admin.master.blog.store') }}",
            edit    : "{{ route('admin.master.blog.edit', ['id' => ':id']) }}",
            show    : "{{ route('admin.master.blog.edit', ['id' => ':id']) }}",
            track   : "{{ route('admin.master.blog.track', ['id' => ':id']) }}",
            delete  : "{{ route('admin.master.blog.delete', ['id' => ':id']) }}"
        };
