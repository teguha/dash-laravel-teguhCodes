<div class="flex flex-row lg:flex-wrap items-center gap-2 justify-end">
    @if(!empty($fields['add']))
        <button data-id="null" data-type="add" class="btn-action inline-flex items-center px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-all text-[8px] md:text-xs lg:text-xs font-medium">
